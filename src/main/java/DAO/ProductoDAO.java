...
public class ProductoDAO extends Conexion implements Serializable{
    ...
    public boolean guardarProducto(Producto producto) throws SQLException{
        ...
        ps.setString(5, producto.getImg());
    ...
    public boolean editarProducto(Producto producto) throws Exception {
        ...
        String sql = "UPDATE producto SET nombre=?,cantidad=?,costo=?,img=?,id_proveedor WHERE id_producto=?";
        ...
        try {
            ...
            consulta.setString(4, producto.getImg());
            consulta.setInt(5, producto.getId_proveedor());
            consulta.setInt(6, producto.getId_producto());
