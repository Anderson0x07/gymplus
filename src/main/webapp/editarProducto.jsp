...
<%
    ...
    product = facadeProducto.buscarProducto(pro); //nuevo producto con todos los datos del que busco por id
%>
<html>
    <head>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>                               
                                                ...
                                                <td>
                                                    ...
                                                    <a href="dashboard/dash-productos.jsp?id=<%= producto.getId()%>">
