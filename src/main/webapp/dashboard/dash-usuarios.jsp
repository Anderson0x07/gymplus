...
<%
    ...
    /*if(request.getParameter("nombreR") != null){ //BOTON REGISTRO
        ...
        Usuario usuario = new Usuario(documento, tipoDoc, nombre, apellido, telefono, Date.valueOf(fechaNacimiento), email, password);
    
        msg = facade.guardarUsuario(usuario);
    }*/
    
    
    if(request.getParameter("numDoc") != null){ //BOTON ELIMINAR
                                        ...
                                        <tbody>
                                            ...
                                            <tr>                               
                                                ...
                                                <td>
                                                    ...
                                                    <a href="dash-usuarios.jsp?numDoc=<%= usuario.getNumeroDoc()%>">
