...
<%
    ...
    if(request.getParameter("id") != null){ //BOTON ELIMINAR
        String id = request.getParameter("id");
    
        Producto pro = new Producto();
        pro.setId_producto(Integer.parseInt(id));
    
        msg = facadeP.eliminarProducto(pro);
        
    }
    
    if(request.getParameter("idProducto") != null){ // BOTON EDITAR
        ...
        Producto producto = new Producto(Integer.parseInt(id), nombre, Integer.parseInt(cantidad), Double.parseDouble(costo),img,Integer.parseInt(pro));

        msg = facadeP.editarProducto(producto);
    }
                                        ...
                                        <tbody>
                                            ...
                                            <tr>                               
                                                ...
                                                <td>
                                                    ...
                                                    <a href="dash-productos.jsp?id=<%= producto.getId_producto()%>">
