...
<%
    ...
    if(request.getParameter("idProducto") != null){ // BOTON EDITAR
        ...
        Producto producto = new Producto(Integer.parseInt(id), nombre, Integer.parseInt(cantidad), Double.parseDouble(costo));
                                        ...
                                        <tbody>
                                            ...
                                            <tr>                               
                                                ...
                                                <td>
                                                    ...
                                                    <a href="dash-productos.jsp?id=<%= producto.getId()%>">
