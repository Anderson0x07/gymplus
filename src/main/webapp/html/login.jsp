                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <div class="container-fluid">
                      ...
                      <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        ...
                        <a id="boton" href="registro.html">Sign in</a> &nbsp &nbsp 
                        <a id="boton" href="carrito.html">
        ...
        <div class="row">
            <div class="col-6">
                <div style="font-size: 11pt;">
                    ...
                    <a href="https://www.google.com" target="_blank" style="text-decoration: none; color: white;">
