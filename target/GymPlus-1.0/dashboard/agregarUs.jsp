<%-- 
    Document   : agregarUs
    Created on : 24/06/2022, 3:55:59 p. m.
    Author     : Anderson
--%>
                                        ...
                                        <div class="card-body">
                                            <form action="../registroUsuarios.jsp" method="post">
                                                ...
                                                <div class="form-group">    
                                                    ...
                                                    <input type="tel" name="telefono" id="telefono" placeholder="Digite su teléfono" required class="form-control"> <br>
                                                </div> 
                                                <div class="form-group">    
                                                ...
                                                <div class="form-group">    
                                                    ...
                                                    <select name="plan" id="plan" required class="form-control">
                                                        ...
                                                        %>
                                                            <option value="<%= plan.getId_plan()%>"><%= plan.getDescripcion()%></option>
                                                        <%
                                                            }
                                                        %>
                                                    </select> <br>
