...
<%@page import="Facade.ProveedorFacade"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<jsp:useBean id="facade2" class="Facade.ProveedorFacade" scope="session"></jsp:useBean>
<%@page session="true"%>
...
<% 
    ...
    ArrayList<Proveedor> proveedores = facade2.buscarProveedores();
%>
<!DOCTYPE html>
<html>
    <head>
                                        ...
                                        <div class="card-body">
                                            <form action="../registroProductos.jsp" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="img" id="img" placeholder="Digite la URL de la imagen del producto" required class="form-control"> <br>
                                                </div> 
